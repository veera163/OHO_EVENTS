...
/**
 * Created by sai on 24-01-2017.
 */

public class VendorEnquaryDomain {
    ...
    private String serviceOrSupplyLocations;
    ...
    public String getServiceOrSupplyLocations() {
        return serviceOrSupplyLocations;
    }

    public void setServiceOrSupplyLocations(String serviceOrSupplyLocations) {
